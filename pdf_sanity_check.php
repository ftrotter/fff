<?php
	...
	$enforce_no_duplicate = true; //duplicates start with a '1.'
	$enforce_no_state_duplicates = true; //Adobe adds these willy nilly...	
	...
	foreach($main_struct as $field => $field_array){
		...
		if(strpos($field,'1.') !== false && $enforce_no_duplicate){
				$has_error = true;
		...
		if($type == 'Button'){ //radio or checkbox for our purposes
			...
			//radios have FieldFlags that are weird..
                        ...
                        if(isset($field_array['FieldStateOption++']) && $enforce_no_state_duplicates){
				$has_error = true;
